...
{
    m_command_executor.register_command(protocol::entity::ServerCommandType::Register, m_register_command);
    m_command_executor.register_command(protocol::entity::ServerCommandType::CreateRoom, m_create_room_command);
    m_command_executor.register_command(protocol::entity::ServerCommandType::ConnectToRoom, m_connect_to_room_command);
}
